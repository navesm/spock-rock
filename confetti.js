...
var maxParticleCount = 130; //set max confetti count
...
function startConfettiInner() {
	...
	if (canvas === null) {
		...
		canvas.setAttribute("style", "position: absolute; z-index:999999;pointer-events:none");
...
function stopConfettiInner() {
	...
	if (animationTimer) {
		window.cancelAnimationFrame(animationTimer); // Cancels any ongoing animation
		animationTimer = null;
	}
}
